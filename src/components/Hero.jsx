    ...
    <section className="max-w-7xl mx-auto px-6 pt-12 mb-24 flex flex-col items-center text-center">
      <div className="space-y-8 max-w-4xl">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-4">
          <button className="w-full sm:w-auto bg-primary text-on-primary px-10 py-4 rounded-lg text-sm uppercase tracking-[0.15em] font-bold neon-glow transition-all active:scale-95 shadow-xl shadow-primary/20">
            Initialize Learning
          </button>
